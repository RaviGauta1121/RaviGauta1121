...
- 💼 I’ve worked on real-time, production-level websites and full-stack applications
- 🏆 Winner at **Hack the Mountain** (Best Beginners Track & TinyMCE Creative Use Prize)
- 🌱 Currently exploring: TypeScript, Data Visualization (D3.js, Chart.js), Microcontrollers (PIC16F877A, ATmega328)
- 🤝 Collaborated on projects like:
  - **Wonderlust** – Airbnb clone using Node.js, EJS, Tailwind CSS, MongoDB
  - **Study Buddy** – All-in-one student productivity tool built with Next.js, MongoDB, TinyMCE
- 👨‍🏫 Web Development Intern at Ganesh Biofuel & Mittal Alliance
- 🧑‍💼 Tech Team Member – **BAD Talks 2024 CEO Summit**
...
![EJS](https://img.shields.io/badge/EJS-black?logo=ejs&logoColor=white)
...
![FusionCharts](https://img.shields.io/badge/FusionCharts-0075C9?logo=fusioncharts&logoColor=white)
...
![TinyMCE](https://img.shields.io/badge/TinyMCE-292929?logo=tinymce&logoColor=white)
...
[![X](https://img.shields.io/badge/-Twitter-000000?logo=x&logoColor=white)](https://x.com/your-profile)
